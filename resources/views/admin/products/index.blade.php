        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <div class="flex items-center gap-2 border-l border-gray-200 pl-3">
                    <a href="{{ route('admin.products.export') }}" class="inline-flex h-10 items-center gap-2 rounded-xl border-2 border-red-500 bg-white px-4 text-sm font-medium text-red-600 shadow-sm transition hover:bg-red-50">
                    ...
                    <tr class="transition hover:bg-gray-50">
                        ...
                        <td class="px-5 py-4">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <button @click="openEdit({{ $product->id }})" class="flex h-8 w-8 items-center justify-center rounded-lg bg-red-500 text-white shadow-sm transition hover:bg-red-600" title="Edit">
                ...
                <div class="mt-6 space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select x-model="form.brand_id" class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm transition focus:border-red-400 focus:outline-none focus:ring-2 focus:ring-red-400/20" :class="errors.brand_id && 'border-red-400'">
                                <option value="">Pilih Brand</option>
                                @foreach($brands as $brand)
                                    <option value="{{ $brand->id }}">{{ $brand->nama }}</option>
                                @endforeach
                            </select>
                            <template x-if="errors.brand_id"><p class="mt-1 text-xs text-red-500" x-text="errors.brand_id[0]"></p></template>
                        </div>
                    </div>
                    <div class="grid grid-cols-2 gap-4">
                        <div>
    ...
    <div x-show="showImportModal" x-cloak class="fixed inset-0 z-50 overflow-y-auto" @keydown.escape.window="showImportModal = false">
        ...
        <div class="flex min-h-full items-center justify-center p-4">
            <div x-show="showImportModal" x-transition class="relative w-full max-w-2xl rounded-2xl bg-white p-8 shadow-xl" @click.stop>
                <h3 class="text-xl font-bold text-gray-900">Import Produk</h3>
                ...
                <div class="mt-6">
                    ...
                    <form action="{{ route('admin.products.import') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mt-6 flex flex-wrap items-center justify-end gap-3 border-t border-gray-100 pt-6">
                            <a href="{{ route('admin.products.template') }}" class="inline-flex items-center gap-2 rounded-xl border-2 border-red-500 bg-white px-4 py-2.5 text-sm font-medium text-red-600 transition hover:bg-red-50">
                                <svg class="h-4 w-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"/></svg>
                                Download Template
                            </a>
