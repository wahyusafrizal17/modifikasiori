...
<div class="space-y-6">
    ...
    <form method="GET" class="flex flex-wrap items-end justify-between gap-4 rounded-xl border border-gray-100 bg-white p-5 shadow-sm">
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('admin.laporan.export-csv', request()->query()) }}" class="inline-flex h-10 items-center gap-2 rounded-xl bg-red-500 px-5 text-sm font-semibold text-white shadow-sm transition hover:bg-red-600">
