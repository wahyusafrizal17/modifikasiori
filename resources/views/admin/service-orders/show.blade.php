...
<div x-data="{ statusLoading: false }" class="space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('admin.service-orders.edit', $serviceOrder) }}" class="inline-flex h-10 items-center gap-2 rounded-xl bg-red-500 px-5 text-sm font-semibold text-white shadow-sm transition hover:bg-red-600">
            ...
            <button @click="updateStatus('selesai')" :disabled="statusLoading" class="inline-flex h-10 items-center gap-2 rounded-xl bg-red-500 px-5 text-sm font-semibold text-white shadow-sm transition hover:bg-red-600 disabled:opacity-50">Selesai</button>
            @endif
