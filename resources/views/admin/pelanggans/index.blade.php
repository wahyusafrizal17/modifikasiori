                    ...
                    <tr class="transition hover:bg-gray-50">
                        ...
                        <td class="px-5 py-4">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <button @click="openEdit({{ $pelanggan->id }})" class="flex h-8 w-8 items-center justify-center rounded-lg bg-red-500 text-white shadow-sm transition hover:bg-red-600">
