...
@section('title', 'Detail Pembelian Luar - ' . $transaksi->kode)
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="rounded-xl border border-gray-100 bg-white p-6 shadow-sm">
                ...
                <p class="mt-1 text-sm text-gray-500">Detail pengajuan pembelian produk dari supplier luar</p>
        ...
        <div class="space-y-6">
            <div class="rounded-xl border border-gray-100 bg-white p-6 shadow-sm">
                ...
                @else
                <div class="mt-5">
                    <a href="{{ route('speedshop.stock-in.pembelian-luar.index') }}" class="flex w-full items-center justify-center gap-2 rounded-xl border border-gray-200 px-5 py-3 text-sm font-medium text-gray-600 transition hover:bg-gray-50">
...
function transaksiDetail() {
    return {
        ...
        async approveTransaksi() {
            ...
            this.loading = true;
            const res = await fetch('{{ route("speedshop.stock-in.pembelian-luar.approve", $transaksi) }}', {
                method: 'POST',
                headers: {
        ...
        async confirmReject() {
            ...
            const res = await fetch('{{ route("speedshop.stock-in.pembelian-luar.reject", $transaksi) }}', {
                method: 'POST',
                headers: {
