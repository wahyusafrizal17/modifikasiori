...
@section('title', 'Input Pembelian Luar Baru')
...
<div x-data="transaksiCreate()" class="space-y-6">
    <nav class="flex items-center gap-2 text-sm text-gray-500">
        ...
        <a href="{{ route('speedshop.stock-in.pembelian-luar.index') }}" class="transition hover:text-gray-700">Pembelian Luar</a>
        <svg class="h-3.5 w-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
                ...
                <div class="mt-5 space-y-4">
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                        <div>
                            ...
                            <select x-ref="supplierSelect" placeholder="Pilih supplier..."></select>
                        </div>
                        <div>
                            <label class="mb-1.5 block text-xs font-semibold text-gray-600">Kode Produk *</label>
                            <select x-ref="productSelect" placeholder="Pilih produk..."></select>
                        </div>
                        <div>
        ...
        <div class="space-y-6">
            <div class="rounded-xl border border-gray-100 bg-white p-6 shadow-sm">
                ...
                <div class="mt-5 space-y-3">
                    ...
                    <a href="{{ route('speedshop.stock-in.pembelian-luar.index') }}" class="flex w-full items-center justify-center rounded-xl border border-gray-200 px-5 py-3 text-sm font-medium text-gray-600 transition hover:bg-gray-50">
                        Batal
                    </a>
                </div>
            </div>
            ...
            <div class="rounded-xl border border-yellow-200 bg-yellow-50 p-4">
                <div class="flex gap-3">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-yellow-700">Setelah disubmit, transaksi akan menunggu persetujuan Manager Speedshop. Stok baru bertambah setelah disetujui.</p>
                    </div>
                </div>
            </div>
        </div>
...
function transaksiCreate() {
    const baseUrl = '{{ url("speedshop/stock-in/pembelian-luar") }}';
    return {
        loading: false,
        addSupplierId: '',
        addProductId: '',
        ...
        async submitTransaksi() {
            ...
            const result = await Swal.fire({
                ...
                text: 'Data akan dikirim untuk diverifikasi oleh Manager Speedshop.',
                icon: 'question',
            ...
            window.location.href = '{{ route("speedshop.stock-in.pembelian-luar.index") }}';
        }
    }
}
</script>
