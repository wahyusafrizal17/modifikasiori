...
@section('title', 'Master Data — Kemasan')
    ...
    <div class="rounded-xl border border-gray-100 bg-white p-6 shadow-sm">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-0.5 text-sm text-gray-500">Daftar kemasan & stok saat ini</p>
            </div>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="transition hover:bg-gray-50">
                        ...
                        <td class="px-5 py-4 text-right">
                            <span class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold {{ $kemasan->stok > 0 ? 'bg-amber-50 text-amber-700' : 'bg-gray-100 text-gray-500' }}">
                                {{ number_format($kemasan->stok) }}
                            </span>
                        </td>
                    </tr>
                    @empty
                    <tr><td colspan="6" class="px-5 py-12 text-center text-gray-400">Belum ada data kemasan.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
