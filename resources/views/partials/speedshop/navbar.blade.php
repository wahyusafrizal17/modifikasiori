                    ...
                    <template x-for="notif in notifications" :key="notif.id">
                        <a :href="notif.link || '#'" @click="markRead(notif)" class="flex gap-3 border-b border-gray-50 px-4 py-3 transition hover:bg-gray-50" :class="!notif.read_at && 'bg-red-50/50'">
                            <div class="flex-shrink-0 mt-0.5">
                                <div class="flex h-8 w-8 items-center justify-center rounded-full" :class="notif.type === 'stock_in_approved' ? 'bg-green-100' : (notif.type === 'stock_in_rejected' ? 'bg-red-100' : (notif.type === 'stock_in_pending' ? 'bg-yellow-100' : 'bg-blue-100'))">
                                    ...
                                    <svg x-show="notif.type === 'stock_in_pending'" class="h-4 w-4 text-yellow-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                    <svg x-show="!['stock_in_approved','stock_in_rejected','stock_in_pending'].includes(notif.type)" class="h-4 w-4 text-blue-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"/></svg>
                                </div>
                            </div>
