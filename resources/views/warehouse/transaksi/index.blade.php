...
@section('title', 'Transaksi Warehouse')
...
<div class="space-y-6">
    ...
    <div class="rounded-xl border border-gray-100 bg-white p-6 shadow-sm">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h2 class="text-xl font-bold text-gray-900">Transaksi Pembelian</h2>
                <p class="mt-1 text-sm text-gray-500">Input stok masuk produk dari supplier (perlu verifikasi Manager)</p>
            </div>
            <div class="flex flex-wrap items-center gap-3">
                ...
                <a href="{{ route('warehouse.transaksi.create') }}" class="inline-flex h-10 items-center gap-2 rounded-xl bg-red-500 px-5 text-sm font-semibold text-white shadow-sm transition hover:bg-red-600 active:scale-[0.98]">
            ...
            <table class="w-full text-left text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="transition hover:bg-gray-50">
                        ...
                        <td class="px-5 py-4">
                            <a href="{{ route('warehouse.transaksi.show', $t) }}" class="flex h-8 w-8 items-center justify-center rounded-lg bg-gray-500 text-white shadow-sm transition hover:bg-gray-600" title="Detail">
